...
## Why it matters
Intercompany loan balances must reconcile between related entities to keep the Balance Sheet consistent.

## Sources & required data
Required:
- QBO Balance Sheet snapshot as-of `period_end`
- Counterparty Balance Sheet evidence as-of `period_end`
